...
const PreSale = () => {
  ...
  return (
    <div className="presale-grid-view">
      <div className=" flex flex-col xl:flex-row justify-between items-center xl:justify-between container mx-auto pb-[96px] px-16">
        <div className="flex flex-col justify-center items-center w-1/2">
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3 pb-[96px]">
            <ButtonPrimary className="btn btn-whitepaper">Whitepaper</ButtonPrimary>
            <ButtonPrimary className="btn btn-audit !bg-transparent">Token Audit</ButtonPrimary>
