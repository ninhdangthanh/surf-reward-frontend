        ...
        <BoxAnimation className="bg-[#151b22] p-[32px] md:p-[64px] rounded-xl lg:pt-[96px] xl:py-[7.8rem] lg:pl-[128px] lg:pr-[64px] xl:pl-[10.4rem] xl:pr-[5.2rem] -mt-5 lg:mt-[5.2rem] lg:w-[72%] ml-auto relative z-0">
          ...
          <p className="text-[18px] lg:text-[20px] xl:text-[1.63rem] text-gray-400">
            ...
            <span className="mt-6 block">
              ...
              headquarters in Düsseldorf, Germany. So far the focus has been on investing in global
              and large scale real estate projects. SURF Reward is their new (blockchain) project
              for which they have assembled a large and strong team. All employees are local, which
              allows for direct communication and cooperation.
            </span>
          </p>
          ...
          {ourAdvisors.map((advisor, index) => (
            <BoxAnimation key={index}>
              <div key={index} className="flex flex-col items-center">
                ...
                <p className="text-gray-300 text-base xl:text-[1.25rem]">{advisor.position}</p>
