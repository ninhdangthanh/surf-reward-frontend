...
const PreSaleWallet = () => {
  ...
  const BNBtokenContract = new ethers.Contract(
    BNBtokenAddress,
    tokenABI,
    BNBprovider
  );
  ...
  const [startFocusBtnConnectWallet, setStartFocusBtnConnectWallet] =
  ...
  const [isOpenModelSelectNetwork, setIsOpenModelSelectNetwork] =
    useState(false);
  ...
  const {
    isLoading: isConfirmingBuyTokenWithUSDT,
    isSuccess: isConfirmdBuyTokenWithUSDT,
  } = useWaitForTransactionReceipt({
    hash,
  });
  ...
  const {
    isLoading: isConfirmingApproveHash,
    isSuccess: isConfirmedApproveHash,
  } = useWaitForTransactionReceipt({
    hash: approveHash,
  });
            ...
            <div className="flex flex-col text-center space-y-3 px-[12px]">
              ...
              <div className="text-[#acb8c4] text-center flex flex-col">
                <div className="text-[#acb8c4] text-center flex flex-col">
                  ...
                  <span className="font-[300] text-[19px]">
                    For {isETH ? "ETH" : "BNB"} buyers: Switch to{" "}
                    {isETH ? "BNB/BSC" : "ETH"} to activate claiming button
                  </span>
                </div>
              </div>
                ...
                <div>
                  <div className="flex flex-row justify-between items-center px-12 py-2">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <span className="text-gray-500 font-[400] text-[15px]">
                        0
                      </span>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="pt-1 border-t-2 border-gray-1 py-2 px-2">
                    ...
                    >
                      {isETH
                        ...
                        : "Switch network to buy with ETH"}
                    </div>
                    ...
                    {switchToken == "USDT" && (
                      <div className="mt-[60px] mb-10">
                        ...
                        <div className="text-start mt-0">
                          Amount allowance:{" "}
                          <strong>{allowanceUSDTShow} USDT</strong>
                        </div>
                        <Input
                          hidden={false}
                          type="number"
                          value={`${inputApprove}`}
                          onChange={(e) =>
                            setInputApprove(Number(e.target.value))
                          }
                    ...
                    <div className="py-6 space-y-12">
                      {isETH ? (
                        <Input
                          ...
                          value={`${amountInput}`}
                          onChange={(e) =>
                            onChangeAmountInput(Number(e.target.value))
                          }
                          placeholder="Enter amount"
                          labelPlacement="outside"
                          size="lg"
